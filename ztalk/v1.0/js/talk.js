...
function cbPostFriendList(result	) {
	...
	str += '	<p class="description">친구를 초대해보세요.</p>';
	str += '</li>';
	...
	$('[data-idx]').on('click', function(){
		var  idx = $(this).attr('data-idx')
			,param = 'idx=' + idx
		if (idx == 'me') {
			_oc.toast(getSetting('user_name') + '님은 ' + getSetting('user_level') + '개의 관심병을 가지고 있습니다.')
		} else if (idx == 'invite') {
